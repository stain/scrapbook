<?php top("With the menu at the top", "top.css"); ?>
    <div class="abstract"> 
      <h2>Abstract</h2>
      <p>
        The same page as the index page, only with the boxes
        moved around. The change is really simple, by just modifying
        the numbers in the style sheet. In addition, some stylistic
        changes has been made to change the representation 
        of the menu. This is an example of having different
        style sheets on the same document. 
        See the <a href="top.css">stylesheet</a>
        for more details.
      </p>
    </div>
    ...
    <p>
     ...
     out the examples from the menu.
    </p>
